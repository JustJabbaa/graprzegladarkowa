    ...
    <div class="container">
        <header class="row border-bottom">
            ...
            <div class="col-12 col-md-6">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3">
                        Kamień: <?php echo $v->showStorage("kamien"); ?>
                    </div>
                    <div class="col-12 col-md-3">
                        Zasób 4
                    </div>
        ...
        <main class="row border-bottom">
            <div class="col-12 col-md-3 border-right">
                ...
                Kopalnia kamienia, poziom <?php echo $v->buildingLVL("kopalniaKamienia"); ?> <br>
                Zysk/h: <?php echo $v->showHourGain("kamien"); ?><br>
                <a href="index.php?action=upgradeBuilding&building=kopalniaKamienia">
                    <button>Rozbuduj kopalnie kamienia</button>
                </a>
            </div>
            <div class="col-12 col-md-6">
                Widok wioski
